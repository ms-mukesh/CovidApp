...
export default class worldnewslist extends Component {
    ...
    makeRemoteRequest = () => {
        ...
        const url =
            'https://newsapi.org/v2/everything?q=COVID&from=2020-03-16&sortBy=publishedAt&apiKey=e060119634074814a39ca5152e88b038&pageSize=100&page=1';
        // India news api : http://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=d5fa370032ac4234b84fdbbe486a3da3
